Pro Grp_L2v7_Flt_Polarization_b, fsearch_String, title=title
  ; This is a variation to Grp_L2v7_Flt_Polarization_a to offset the angle by 90 deg.
  ; This is because the polarization angle is measured from the north angle anti clock wise
  ; instead of the horizontal anti clockwise
  ;
  ...
  For p = 0, nfiles-1 Do Begin ; open each file
    ...
    ;
    ;-- Projection to Sky Coordinate System and offsetting fro the horizontal.
    ;
    P0_Arr = 90.0 - P0_Arr
    P2_Arr = 90.0 - P2_Arr
    P3_Arr = 90.0 - P3_Arr
    ...
    P7_Arr = 90.0 - P7_Arr
    P9_Arr = 90.0 - P9_Arr
    P10_Arr = 90.0 - P10_Arr

    P11_Arr = 90.0 - P11_Arr
    P12_Arr = 90.0 - P12_Arr
    P13_Arr = 90.0 - P13_Arr
    P14_Arr = 90.0 - P14_Arr

    P17_Arr = 90.0 - P17_Arr
    P18_Arr = 90.0 - P18_Arr
    P19_Arr = 90.0 - P19_Arr
    P20_Arr = 90.0 - P20_Arr

    P21_Arr = 90.0 - P21_Arr
    P22_Arr = 90.0 - P22_Arr
    P24_Arr = 90.0 - P24_Arr
    P25_Arr = 90.0 - P25_Arr
    P27_Arr = 90.0 - P27_Arr
    P28_Arr = 90.0 - P28_Arr
    P29_Arr = 90.0 - P29_Arr
    P31_Arr = 90.0 - P31_Arr
