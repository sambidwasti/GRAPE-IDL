pro grp_l1_flt_process_v1, fsearch_string, auxpath, nfiles=nfiles, iverbose=iverbose

  ;****************************************************************************************
  ; Name:
  ;   GRP_LEVEL1_FLT_PROCESS
  ;
  ; Version No: 6.1 ( this is the first version for this program but generates level 1 ver 6)
  ;
  ; Purpose:
