pro Cal_Energy_V1_2, InputFileFolderPath, OutputFileFolderPath, File = File, Anode = Anode, Type = Type, Thresh=Thresh, Log=Log , BINS = BINS
...
print, FName
                    ...
                    While not EOF(logicunit) DO Begin
                              Temp_Count++
                              READF, logicUnit, data                                    ; Read the file and dump each line
...
;                    EndFor ; End i ( Each Line )
             ...
             ;======== = =========== *********DATA SELECTION AND PROCESSING******** ================== = =
               ...
               For p = 0, 63 Do Begin                          ; Now we have extracted all the anode pulse heights. Now we process for Each Anode.
                        ...
                        For i=0,1023 Do Back_Hist[i] = Anode_Histogram[Back_Index,p,i]
                        ...
                        For q = 0, NSrc-1 Do Begin
                                ...
                                If AnodeType(Anode) EQ 0 Then X_MAX = 300 Else X_MAX = 300
...
;                                
                                ...
                                If( q NE Back_Index) Then Begin
                                               ...
                                               If A_Log EQ True THen BEgin
                                                          ...
                                                          EndFor
                                               EndIF           
                                               Plot, XFIT1,Hist1, PSYM=10, Title = Src[q]+'Scaled'+Strn(N_Bins)+TitleName,  XRANGE=[100,X_MAX],XSTYLE=1
