pro grp_l1v6_flt_process, fsearch_string, auxpath, nfiles=nfiles, iverbose=iverbose

  ;****************************************************************************************
  ; Name:
  ;   GRP_LEVEL1_FLT_PROCESS
  ;
  ; Version No: 6.2 (current version)
  ;           : If this needs to be changed, this is going to be archived as v6.2
  ;
  ; Purpose:
  ...
  ;=========================================================================================
  ;
  ;  Module serial number for each of the 24 flight detectors ;     Edited from 16 to 24 but we need the empty to be 0 to work.: SW
  ...
  For ifile = 0, nfiles-1 Do Begin
    ...
    For i = 0, nevts-1 Do Begin
      ...
      Linterp, *ltable_evtime[im[0]], *ltable_ltime[im[0]], (l1data[i].evtime+1.0), Temp_LT
