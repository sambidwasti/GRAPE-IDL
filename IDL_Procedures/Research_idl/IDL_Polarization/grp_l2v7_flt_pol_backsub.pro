Pro Grp_L2v7_Flt_Pol_BackSub, Crab_Pol_Files, PCA_bgdfile , title=title
...
CgPlot, Xval1,Main_Crab, psym=10,Err_ylow=main_err, Err_yhigh=main_err,  /err_clip $
  ...
  , yrange=[0,ymax], ystyle=1, ytitle='Counts', Xtitle='Azi Scat Angle', title='Total Scat angle Histogram (PV Cord)'
CgErase
