Pro Grp_L2v7_Flt_Polarization, fsearch_String, title=title
  ;
  ...
  CgPS_Open, title+'_Flt_Polarization.ps', Font =1, /LandScape
  cgLoadCT, 13
    ...
    out_fname = Strmid(fname, 0,pos1)+'.txt'
   ...
   ;     Print, AvgLT_Arr
      ...
      ;  print, imflag_Cnt, Evt_Cnt, 'IMFlag and Events'
  ...
  CgPS_Close
  Temp_Str = Cur+'/'+title+'_Flt_Polarization.ps'
