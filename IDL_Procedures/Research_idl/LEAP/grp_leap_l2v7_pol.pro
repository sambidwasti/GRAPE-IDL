Pro Grp_Leap_L2v7_Pol, fsearch_String, title=title
  Close, /all
  ;
 ...
 Title1 =Title+'_grp_leap_pol'
  ...
  For p = 0, nfiles-1 Do Begin ; open each file
    ...
    EndFor; /i
     ...
     ;-- Concat the Array --
    If N_elements(P0_Arr) NE 1 then P0_ARR =P0_Arr[1:N_Elements(P0_Arr)-1] Else P0_Arr=[-1.0]
    If N_elements(P2_Arr) NE 1 then P2_ARR =P2_Arr[1:N_Elements(P2_Arr)-1] Else P2_Arr=[-1.0]
    If N_elements(P3_Arr) NE 1 then P3_ARR =P3_Arr[1:N_Elements(P3_Arr)-1] Else P3_Arr=[-1.0]
    If N_elements(P4_Arr) NE 1 then P4_ARR =P4_Arr[1:N_Elements(P4_Arr)-1] Else P4_Arr=[-1.0]
    If N_elements(P6_Arr) NE 1 then P6_ARR =P6_Arr[1:N_Elements(P6_Arr)-1] Else P6_Arr=[-1.0]
    If N_elements(P7_Arr) NE 1 then P7_ARR =P7_Arr[1:N_Elements(P7_Arr)-1] Else P7_Arr=[-1.0]
    If N_elements(P9_Arr) NE 1 then P9_ARR =P9_Arr[1:N_Elements(P9_Arr)-1] Else P9_Arr=[-1.0]
    
    If N_elements(P10_Arr) NE 1 then P10_ARR =P10_Arr[1:N_Elements(P10_Arr)-1] Else P10_Arr=[-1.0] 
    If N_elements(P11_Arr) NE 1 then P11_ARR =P11_Arr[1:N_Elements(P11_Arr)-1] Else P11_Arr=[-1.0] 
    If N_elements(P12_Arr) NE 1 then P12_ARR =P12_Arr[1:N_Elements(P12_Arr)-1] Else P12_Arr=[-1.0] 
    If N_elements(P13_Arr) NE 1 then P13_ARR =P13_Arr[1:N_Elements(P13_Arr)-1] Else P13_Arr=[-1.0] 
    If N_elements(P14_Arr) NE 1 then P14_ARR =P14_Arr[1:N_Elements(P14_Arr)-1] Else P14_Arr=[-1.0] 
    If N_elements(P17_Arr) NE 1 then P17_ARR =P17_Arr[1:N_Elements(P17_Arr)-1] Else P17_Arr=[-1.0]
    If N_elements(P18_Arr) NE 1 then P18_ARR =P18_Arr[1:N_Elements(P18_Arr)-1] Else P18_Arr=[-1.0] 
    If N_elements(P19_Arr) NE 1 then P19_ARR =P19_Arr[1:N_Elements(P19_Arr)-1] Else P19_Arr=[-1.0] 
    
    If N_elements(P20_Arr) NE 1 then P20_ARR =P20_Arr[1:N_Elements(P20_Arr)-1] Else P20_Arr=[-1.0] 
    If N_elements(P21_Arr) NE 1 then P21_ARR =P21_Arr[1:N_Elements(P21_Arr)-1] Else P21_Arr=[-1.0] 
    If N_elements(P22_Arr) NE 1 then P22_ARR =P22_Arr[1:N_Elements(P22_Arr)-1] Else P22_Arr=[-1.0] 
    If N_elements(P24_Arr) NE 1 then P24_ARR =P24_Arr[1:N_Elements(P24_Arr)-1] Else P24_Arr=[-1.0] 
    If N_elements(P25_Arr) NE 1 then P25_ARR =P25_Arr[1:N_Elements(P25_Arr)-1] Else P25_Arr=[-1.0] 
    If N_elements(P27_Arr) NE 1 then P27_ARR =P27_Arr[1:N_Elements(P27_Arr)-1] Else P27_Arr=[-1.0] 
    If N_elements(P28_Arr) NE 1 then P28_ARR =P28_Arr[1:N_Elements(P28_Arr)-1] Else P28_Arr=[-1.0] 
    If N_elements(P29_Arr) NE 1 then P29_ARR =P29_Arr[1:N_Elements(P29_Arr)-1] Else P29_Arr=[-1.0] 
    If N_elements(P31_Arr) NE 1 then P31_ARR =P31_Arr[1:N_Elements(P31_Arr)-1] Else P31_Arr=[-1.0] 
   
   
   ;-- Histogram it
   Pol_0 = CgHistogram(P0_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_2 = CgHistogram(P2_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_3 = CgHistogram(P3_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_4 = CgHistogram(P4_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_6 = CgHistogram(P6_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_7 = CgHistogram(P7_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_9 = CgHistogram(P9_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_10 = CgHistogram(P10_Arr, Min=0, Max=360, BinSize=20, Locations=X1)

   Pol_11 = CgHistogram(P11_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_12 = CgHistogram(P12_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_13 = CgHistogram(P13_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_14 = CgHistogram(P14_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_17 = CgHistogram(P17_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_18 = CgHistogram(P18_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_19 = CgHistogram(P19_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_20 = CgHistogram(P20_Arr, Min=0, Max=360, BinSize=20, Locations=X1)

   Pol_21 = CgHistogram(P21_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_22 = CgHistogram(P22_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_24 = CgHistogram(P24_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_25 = CgHistogram(P25_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_27 = CgHistogram(P27_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_28 = CgHistogram(P28_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_29 = CgHistogram(P29_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
   Pol_31 = CgHistogram(P31_Arr, Min=0, Max=360, BinSize=20, Locations=X1)
...
;  Rot_angle = Rot_angle[1:N_Elements(Rot_Angle)-1]
;  Sel_Scat_Angle = Sel_Scat_Angle[1:N_Elements(Sel_Scat_Angle)-1]
;  Pv_Ang = PV_Angle[1:N_Elements(PV_Ang)-1]
;  TOtNrg_all = TotNrg_all[1:N_Elements(TotNRg_all)-1]
;
;
;  Sct_Hist_Sel = CgHistogram(Sel_Scat_Angle, Min=0, Max=360, BinSize=20, Locations=X)
;  Sct_hist = CgHistogram(Pv_Ang, Min=0, Max=360, BinSize=20, Locations=X1)
;  TotNRg = CgHistogram(TotNrg_all, Min=0, Max=500, Binsize=5, Locations= X2)
;
...
;  CgErase
;
;  CgPlot, X, Sct_HIst_Sel,Title=' Sel Scat Angle',Ytitle=' Counts', XTitle='Angle', PSYm=10
;  CgErase
;
;  CgPlot, X1, Sct_Hist, title='Full Scat Angle', ytitle='Counts', Xtitle='Angle', PSYM=10
;  CgERase
;
;  CgPlot, X2, TotNrg, Title ='All Energy', ytitle='Counts', Xtitle='Energy', PSYM= 10
;
;  CgPs_Close
;
;  ;  -- Create the PDF File
...
CgPlot, X1, Total_hist, PSYM=10
  ;-- TExt Files --
 Openw, Lun, Title1+'_TotNrg.txt', /Get_lun
