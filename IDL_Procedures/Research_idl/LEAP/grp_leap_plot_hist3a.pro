Pro Grp_leap_Plot_hist3a, Pol, UnPol,  title=title, Bin = Bin
;----------------------
...
A0 = MIN(Main_Hist)
A1 = Max(Main_Hist)-MIn(Main_Hist)
A2 = 1
...
Ymin=0
 ; Main_Err = Sqrt(Src_Err*SRc_ERr + Scl_Berr*Scl_Berr)
  ...
  CgPs_Open, title+'_hist3a.ps', Font =1, /LandScape
  cgLoadCT, 13
  ...
  CgLegend, Location=[0.76,1.02], Titles=['Pol','UnPol','Corrected Pol'], Length =0, $
