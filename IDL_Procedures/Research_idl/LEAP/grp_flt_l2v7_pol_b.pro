Pro Grp_Flt_l2v7_Pol_b, fsearch_String, nfiles=nfiles, title=title, Type = Type
  ;****************************************************************
  ; This is a child of Flt_l2v7_Pol_a
  ; Here we are collecting PvAngle rather than Scat Angle.
  ...
  For p = 0, nfiles-1 Do Begin ; open each file
    ...
    For i = 0, TotPkt-1 Do Begin
      ...
      ;Scatter_Angle = Double( Event_Data[i].PVAng)
       ...
       ;print, rt_ang
        Pv_angle = Double(Event_Data[i].pvang)
      ...
      ;
      If Mod_Pos EQ 0 Then P0_Arr  = [P0_Arr,Pv_angle]
      If Mod_Pos EQ 2 Then P2_Arr  = [P2_Arr,Pv_angle]
      If Mod_Pos EQ 3 Then P3_Arr  = [P3_Arr,Pv_angle]
      If Mod_Pos EQ 4 Then P4_Arr  = [P4_Arr,Pv_angle]
      If Mod_Pos EQ 6 Then P6_Arr  = [P6_Arr,Pv_angle]
      If Mod_Pos EQ 7 Then P7_Arr  = [P7_Arr,Pv_angle]
      If Mod_Pos EQ 9 Then P9_Arr  = [P9_Arr,Pv_angle]
      If Mod_Pos EQ 10 Then P10_Arr = [P10_Arr,Pv_angle]

      If Mod_Pos EQ 11 Then P11_Arr = [P11_Arr,Pv_angle]
      If Mod_Pos EQ 12 Then P12_Arr = [P12_Arr,Pv_angle]
      If Mod_Pos EQ 13 Then P13_Arr = [P13_Arr,Pv_angle]
      If Mod_Pos EQ 14 Then P14_Arr = [P14_Arr,Pv_angle]

      If Mod_Pos EQ 17 Then P17_Arr = [P17_Arr,Pv_angle]
      If Mod_Pos EQ 18 Then P18_Arr = [P18_Arr,Pv_angle]
      If Mod_Pos EQ 19 Then P19_Arr = [P19_Arr,Pv_angle]
      If Mod_Pos EQ 20 Then P20_Arr = [P20_Arr,Pv_angle]

      If Mod_Pos EQ 21 Then P21_Arr = [P21_Arr,Pv_angle]
      If Mod_Pos EQ 22 Then P22_Arr = [P22_Arr,Pv_angle]
      If Mod_Pos EQ 24 Then P24_Arr = [P24_Arr,Pv_angle]
      If Mod_Pos EQ 25 Then P25_Arr = [P25_Arr,Pv_angle]
      If Mod_Pos EQ 27 Then P27_Arr = [P27_Arr,Pv_angle]
      If Mod_Pos EQ 28 Then P28_Arr = [P28_Arr,Pv_angle]
      If Mod_Pos EQ 29 Then P29_Arr = [P29_Arr,Pv_angle]
      If Mod_Pos EQ 31 Then P31_Arr = [P31_Arr,PV_angle]
   ...
   TotPkt1 = N_elements(Event_Data[Where(Event_Data.qflag GE 0)]) 
    Rates = [Rates,TotPkt1]
    Rates1= [Rates1,TotPkt]
    Rates2= [Rates2,Cnt_Rates]
    Rates3= [Rates3,Cnt_Rates1]
  ...
  Openw, Lunger, Cur+'/'+Title+'_n'+strn(nfiles)+'_Polb_PolHist.txt', /Get_Lun
  ...
  ;
  Openw, Lunger1, Cur+'/'+Title+'_n'+strn(nfiles)+'_Polb_EnerHist.txt', /Get_Lun
  ...
  CGPlot, Rates1[1:N_Elements(Rates1)-1],PSYM=10, title=title, ytitle='Counts(Events) for a sweep'
  CgOplot, Rates[1:N_Elements(Rates)-1],PSYM=10,Color='red'
  window,2
  CgPlot,  Rates3[1:N_Elements(Rates3)-1],PSYM=10, title=title, ytitle='Counts(Events) for a sweep'
  CgOplot, Rates2[1:N_Elements(Rates2)-1],PSYM=10,Color='Blue'
