pro Grp_L2v7_Flt_process, fsearch_string, nfiles=nfiles, iverbose=iverbose
  ...
  ;
  ; Purpose:
  ;   Grape Level 2 Flight Process for Version 7 Codes
  ;
  ; Calling Sequence:
  ;
  ;
  ...
  ;
  ; Updated this from 20 -> 64 14th Dec.
  ;
...
Print, Sweep
    ...
    For ievt = 0L, nevents-1 do begin
      ...
      rtang    = l1data[ievt].rtang
       ;
      ;--- Check the quality flag and skip the bad event.
      ;
      ...
      If Qflag LT 0 Then goto, Finish_Event
