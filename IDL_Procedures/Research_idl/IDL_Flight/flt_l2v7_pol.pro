Pro Flt_l2v7_Pol, fsearch_String, nfiles=nfiles, title=title, Ener=Ener, Type = Type
  ; *************************************************************************
  ; *           Create a Polarization and PC Energy Spectrum                *
  ; *************************************************************************
  ; * Version: 1.01                                                         *
  ; *                                                                       *
  ; * Purpose:  Read in the Level 2 Version 7 processed files and generate  *
  ; *           Polarization spectrum and PC energy spectrum Histograms     *
  ; *                                                                       *
  ; *                                                                       *
  ; * References: Flt_L1_Read.pro                                           *
  ; *            [ Reads in Flight level 2 version 7 files ]                *
  ; *                                                                       *
  ; * Usage: Flt_l2v7_Pol, '*L2*.dat'                                          *
  ; *                                                                       *
  ; *                     ******KEYWORDS*******                             *
  ; *     Keyword Parameters::                                              *
  ...
  ; *                  - Its quicker and less cluttered way.                *
  ; *                  - Reading in a structure directly                    *
  ; *                                                                       *
  ; *        12/15/15  Sambid Wasti                                         *
  ; *                  - The PV angles are already transformed so using that*
  ; *                 
  ; *                                                                       *
