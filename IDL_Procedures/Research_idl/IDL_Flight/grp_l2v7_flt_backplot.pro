Pro Grp_L2v7_Flt_BackPlot, fsearch_String, Title= Title, nfiles=nfiles, Scl_Time=Scl_Time
...
Jump_Avg:         
       ...
       Print, AVTIME
        ...
        If Event_Data[i].Source EQ 1 Then Begin ; this is crab
          ...
          Avg_Crb_Time= [Avg_Crb_Time, AVTime]
        Endif 
        ...
        If Event_Data[i].Source EQ 2 Then Begin ; this is crab
          ...
          Avg_Sun_Time= [Avg_Sun_Time, AvTime]
        Endif
        ...
        If Event_Data[i].Source EQ 6 Then Begin ; this is crab
          ...
          Avg_Blk2_Time= [Avg_Blk2_Time, AvTime]
        Endif
        ...
        If Event_Data[i].Source EQ 7 Then Begin ; this is crab
          ...
          Avg_Blk4_Time= [Avg_Blk4_Time, AvTime]
        Endif
        ...
        If Event_Data[i].Source EQ 4 Then Begin ; this is crab
          ...
          Avg_Cyg_Time= [Avg_Cyg_Time, AvTime]
        Endif
...
;      Endif
  ...
  help, avg_sun_time, avg_Crb_Time, Avg_Blk2_Time, Avg_Crb_Cnt

  Avg_Sun_Time =  Avg_Sun_Time[1:N_Elements(Avg_Sun_Time)-1]
  Avg_Crb_Time =  Avg_Crb_Time[1:N_Elements(Avg_Crb_Time)-1]
  Avg_Blk2_Time=  Avg_Blk2_Time[1:N_Elements(Avg_Blk2_Time)-1]
  Avg_Blk4_Time=  Avg_Blk4_Time[1:N_Elements(Avg_Blk4_Time)-1]
  Avg_Cyg_Time =  Avg_Cyg_Time[1:N_Elements(Avg_Cyg_Time)-1]
;  help, spec_Cnt
...
;  Spec_Zen = Spec_Zen[1:N_Elements(Spec_Zen)-1]
  ...
  ; Counts vs Zenith
  CgScatter2D, Avg_Crb_Zen, Avg_Crb_Cnt/Scl_Time , Fit=0, Xtitle ='Zenith Angle (Deg)',Title=Str_Title,Ytitle='Counts / Sec',$
    YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Xrange=[-5,60],Xstyle=1,$
    Position= cgLayout([1,2,1], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]), PSYM=45,Color='red',/noerase
    
        CgScatter2D, Avg_Sun_Zen, Avg_Sun_Cnt/Scl_Time, Fit=0, Xtitle ='Zenith Angle (Deg)',Title=Str_Title,Ytitle='Counts / Sec',$
          YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Xrange=[-5,60],Xstyle=1,$
          Position= cgLayout([1,2,1], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]), PSYM=45,Color='Blue',/noerase,/Overplot
          
              CgScatter2D, Avg_Blk2_Zen, Avg_Blk2_Cnt/Scl_Time, Fit=0, Xtitle ='Zenith Angle (Deg)',Title=Str_Title,Ytitle='Counts / Sec',$
              YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Xrange=[-5,60],Xstyle=1,$
              Position= cgLayout([1,2,1], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]), PSYM=45,Color='Dark Green',/noerase,/Overplot
              
                      CgScatter2D, Avg_Blk4_Zen, Avg_Blk4_Cnt/Scl_Time, Fit=0, Xtitle ='Zenith Angle (Deg)',Title=Str_Title,Ytitle='Counts / Sec',$
                      YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Xrange=[-5,60],Xstyle=1,$
                      Position= cgLayout([1,2,1], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]), PSYM=45,Color='Green',/noerase,/Overplot
                              
                            CgScatter2D, Avg_Cyg_Zen, Avg_Cyg_Cnt/Scl_Time, Fit=0, Xtitle ='Zenith Angle (Deg)',Title=Str_Title,Ytitle='Counts / Sec',$
                            YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Xrange=[-5,60],Xstyle=1,$
                            Position= cgLayout([1,2,1], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]), PSYM=45,Color='Orange',/noerase,/Overplot  
                                    
                                    CgPlot, Avg_Cyg_Zen, Avg_Cyg_Cnt/Scl_Time, Fit=0, Xtitle ='Zenith Angle (Deg)',Title=Str_Title,Ytitle='Counts / Sec',$
                                    YRange=[10,20],YStyle=1,AxisColor='Black',Xrange=[-5,60],Xstyle=1,$
  ...
  CgText, !D.X_Size*0.98,!D.Y_Size*0.97, 'Pla = 6~200 kev',/Device,Charsize=1.0
  CgText, !D.X_Size*0.98,!D.Y_Size*0.95, 'Cal = 20~400 kev',/Device,Charsize=1.0
  CgText, !D.X_Size*0.98,!D.Y_Size*0.93, 'Tot = 80~200 kev',/Device,Charsize=1.0
  ...
  CgScatter2D, Avg_Crb_Alt, Avg_Crb_Cnt/Scl_Time, Fit=0, Xtitle ='Altitude (kFt)',Title=Str_Title,Ytitle='Counts / Sec',$
    YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Color='RED',Xrange=[115,135],Xstyle=1,$
    Position= cgLayout([1,2,2], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]),PSYM=45, /noerase
    
        CgScatter2D, Avg_Sun_Alt, Avg_Sun_Cnt/Scl_Time, Fit=0, Xtitle ='Altitude (kFt)',Title=Str_Title,Ytitle='Counts / Sec',$
          YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Color='Blue',Xrange=[115,135],Xstyle=1,$
          Position= cgLayout([1,2,2], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]),PSYM=45, /noerase, /OverPlot
                
                CgScatter2D, Avg_Blk2_Alt, Avg_Blk2_Cnt/Scl_Time, Fit=0, Xtitle ='Altitude (kFt)',Title=Str_Title,Ytitle='Counts / Sec',$
                YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Color='Dark Green',Xrange=[115,135],Xstyle=1,$
                Position= cgLayout([1,2,2], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]),PSYM=45, /noerase, /OverPlot
                
                      CgScatter2D, Avg_Blk4_Alt, Avg_Blk4_Cnt/Scl_Time, Fit=0, Xtitle ='Altitude (kFt)',Title=Str_Title,Ytitle='Counts / Sec',$
                      YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Color='Green',Xrange=[115,135],Xstyle=1,$
                      Position= cgLayout([1,2,2], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]),PSYM=45, /noerase, /OverPlot
                      
                              CgScatter2D, Avg_Cyg_Alt, Avg_Cyg_Cnt/Scl_Time, Fit=0, Xtitle ='Altitude (kFt)',Title=Str_Title,Ytitle='Counts / Sec',$
                              YRange=[10,20],YStyle=1,AxisColor='Black',SymSize=0.5,Color='Orange',Xrange=[115,135],Xstyle=1,$
                              Position= cgLayout([1,2,2], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]),PSYM=45, /noerase, /OverPlot
                                    
                                      CgPlot, Avg_Cyg_Alt, Avg_Cyg_Cnt/Scl_Time, Fit=0, Xtitle ='Zenith Angle (Deg)',Title=Str_Title,Ytitle='Counts / Sec',$
                                    YRange=[10,20],YStyle=1,AxisColor='Black',Xrange=[-5,60],Xstyle=1,$
                                    Position= cgLayout([1,2,1], xgap=0, ygap=12, oxmargin = [5,5], oymargin = [10,5]), Color='brown',/noerase,/Overplot
...
;  CgText, !D.X_Size*0.78,!D.Y_Size*0.45, 'Altitude =('+STRN(Float(Altitude))+'+/- 0.1)kFt',/DEVICE, CHarSize=2.0
  ...
  Openw, LUn, Cur+'/'+Title+'_'+Strn(Scl_Time)+'.txt',/Get_Lun 
      ...
      For i =0, N_Elements(Avg_Sun_Alt)-1 Do Begin
          ...
          Printf, Lun, Avg_Sun_Time[i],Avg_Sun_Cnt[i],Avg_Sun_Zen[i],Avg_Sun_Alt[i],$
                format = '("Sun",1X,F11.2,1X, F8.2,1X, F8.2,1X, F8.2)'
      Endfor
      
      ;Blank2
      For i =0, N_Elements(Avg_blk2_Alt)-1 Do Begin
          Printf, Lun, Avg_blk2_Time[i], Avg_blk2_Cnt[i], Avg_blk2_Zen[i], Avg_blk2_Alt[i],$
          format = '("Blank2",1X,F11.2,1X, F8.2,1X, F8.2,1X, F8.2)'
              
      Endfor
      
      ;Cyg X1
      For i =0, N_Elements(Avg_Cyg_Alt)-1 Do Begin
         Printf, Lun, Avg_Cyg_Time[i], Avg_Cyg_Cnt[i], Avg_Cyg_Zen[i], Avg_Cyg_Alt[i], $
            format = '("CygX1",1X,F11.2,1X, F8.2,1X, F8.2,1X, F8.2)'
      Endfor
      
      ;Blank4
      For i =0, N_Elements(Avg_blk4_Alt)-1 Do Begin
        Printf, Lun, Avg_blk4_Time[i], Avg_blk4_Cnt[i], Avg_blk4_Zen[i], Avg_blk4_Alt[i], $
            format = '("Blank4",1X,F11.2,1X, F8.2,1X, F8.2,1X, F8.2)'
      Endfor
      
      For i =0, N_Elements(Avg_Crb_Alt)-1 Do Begin
        Printf, Lun, Avg_Crb_Time[i], Avg_Crb_Cnt[i], Avg_Crb_Zen[i], Avg_Crb_Alt[i], $
             format = '("Crab",1X,F11.2,1X, F8.2,1X, F8.2,1X, F8.2)'
      Endfor
