Pro Grp_Pha_Hdw_Limit, fsearch_String, Title= Title, nfiles=nfiles, type = type
  ...
  For p = 0, nfiles-1 Do Begin ; open each file
    ...
    ;        If NAnodes GE 2 Then goto, Jump_Packet
      ...
      Pha= LONG(Event_Data[i].Anode_Pha_1)

      If Pha LT PMAX Then EnergyArray[ModuleNo, ANode, Pha]++
      ...
      Pha= LONG(Event_Data[i].Anode_Pha_2)
      ...
      Pha= LONG(Event_Data[i].Anode_Pha_3)
      ...
      Pha= LONG(Event_Data[i].Anode_Pha_4)
      ...
      Pha= LONG(Event_Data[i].Anode_Pha_5)
      ...
      Pha= LONG(Event_Data[i].Anode_Pha_6)
      ...
      Pha= LONG(Event_Data[i].Anode_Pha_7)
      ...
      Pha= LONG(Event_Data[i].Anode_Pha_8)
  ...
  cgPS_Open, Title+'_Lower_Pulse_Hdw.ps', Font=1
  cgDisplay, 800, 800
  cgLoadCT, 13
    ...
    If (where (i EQ c2014) GE 0) Then Begin
      ...
      For j = 0, 63 Do Begin
        ...
        If (where (j EQ pls_anodes) GE 0) Then Begin
          ...
          CgPlot, Indgen(PMAX), EnergyArray[i,j,*], Xtitle ='Energy (kEv) ',Title=Str_Title,$
          ...
          CgPlot, Indgen(PMAX), EnergyArray[i,j,*], Xtitle ='Energy (kEv) ',Title=Str_Title,$
            XRange=[0,Xmax],XStyle=1, Xtickinterval=10,PSYM=10, YRange=[0,Ymax],YStyle=1,Color=CgColor('Blue'),$
  ...
  Temp_Str = Title+'_Lower_Pulse_Hdw.ps'
