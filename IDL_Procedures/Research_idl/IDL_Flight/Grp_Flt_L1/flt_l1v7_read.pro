Pro Flt_l1v7_read, fsearch_String, nfiles=nfiles, title= title
  ;
  ; Template to read in Level 1 version 7 
  ; Need to update from Previous version to read in version 7
  ;-- Last Updated : Sambid Wasti
  ;                  Jan 22, 2015 Updated from level 1 version 6
