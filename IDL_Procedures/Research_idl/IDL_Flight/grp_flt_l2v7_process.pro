pro Grp_Flt_l2v7_process, fsearch_string, nfiles=nfiles, iverbose=iverbose
  ...
  ;                
  ;   S. Wasti      - Feb 25, 2019
  ;                 - Few more updates. and some additional updates.
  ;
  ;
  ;****************************************************************************************
  ...
  For ifile = 0, nfiles-1 do begin
    ...
    For ievt = 0L, nevents-1 do begin
      ...
      totnrg    = l1data[ievt].totnrg
      totnrgsig =l1data[ievt].totsig
      ...
      If acflag eq 1 then goto, finish_event
...
;print, sctang
      ...
      l2data[ievt].ACFLAG     = l1data[ievt].acflag
    ...
    ;  Print, sctang, '---'
      ...
      If ievt mod 10000 EQ 0 Then print, ievt

     ; if ievt gt 100 then stop
      ;
