Pro Grp_L2v7_FltHist1, fsearch_String, Title= Title, Type=Type, Class = Class, Sep = Sep, Bin=bin
...
;  printf, lun101, STring(evtfiles)
  ...
  For p = 0, nfiles-1 Do Begin ; open each file
    ...
    Out_Tfile = Temp_str+'_FltHist1.txt'
    ...
    EnerERr = FltArr(NBin)
        ...
        For i = 0, NBin-2 Do Begin
              PRintf, lun102, XVar[i], Xvar[i]+Bin_Size, EnerArr[i], EnerErr[i]
        EndFor
