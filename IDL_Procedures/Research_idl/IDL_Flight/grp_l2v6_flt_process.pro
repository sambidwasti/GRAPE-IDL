pro Grp_L2v6_Flt_process, fsearch_string, auxpath, nfiles=nfiles, iverbose=iverbose
  ...
  ;
  ; Version: 6.0 (Current)
  ;   Calling it version 6.0 as it uses version 6 of level 1 processing.
  ;
  ; Purpose:
  ;   Grape Level 2 Flight Process for Version 6 Codes
  ;
  ; Calling Sequence:
  ;
  ;
  ...
  If n_params() Ne 2 Then fsearch_string = 'L1*.dat'
  ...
  ;   3 -
  ;   4 -
  ;   5 - Flagged Anodes in Calibration.      -- ( SW ) --
  ;   6 -
  ;   7 -
  ;   8 -
  ;   9 -
  ...
  For ifile = 0, nfiles-1 do begin
    ...
    ;     Each level 1 event has a size of 177 bytes. Changed from 241.0 SW
    ;
    L1msize = 177.0               ; level 1 event message size
    ...
    For ievt = 0L, nevents-1 do begin
      ...
      ;
      verno      = 6            ;-- (Changed from 8 to 6 -- SW --)  --
      qflag      = 0
      pa_mod     = -1
      pa_ser     = -1
      pa_id      = -1
