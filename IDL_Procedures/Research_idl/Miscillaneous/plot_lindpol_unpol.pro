...
Epsilon = 1/denom
denom1 = Epsilon + Epsilon^(-1) - sin(Xfit1)^2
Lin_100 = sin(Xfit1)^2 / denom1

cd, cur=cur
CgPS_Open,'KN_LinearDeg_UnPol.ps', Font =1, /LandScape
cgLoadCT, 13
...
CgLegend, Location=[0.70,0.885], Titles=Leg_Text, length =0.075,color=['black','black','black','black','black'],$
  ...
  CgPS_Close
  Temp_Str = Cur+'/'+'KN_LinearDeg_UnPol.ps'
