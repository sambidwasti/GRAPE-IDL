Pro gsim_grp_compare_gamma1, file1, file2, title=title, bin=bin, PSD=PSD, sel=sel
...
print,'Executed'
  ...
  ;-- Read in the sims --
  ;
  simfile = file_search(file2+'/*gamma_com.txt')
  ...
  If Sel_Flag eq true then begin
    St_Estimated = Gamma12[sel_min:sel_max]
