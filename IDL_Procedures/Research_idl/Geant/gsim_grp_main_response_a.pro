Function GSim_GRP_Main_response_a, infile, title=title, bin=bin, N=N, Input_Ener= Input_Ener, Class=Class, type=type

  ; Similar to Gsim_Grp_Main_Response but this has an extra keyword for class.
  ; Also including type
  ; 
