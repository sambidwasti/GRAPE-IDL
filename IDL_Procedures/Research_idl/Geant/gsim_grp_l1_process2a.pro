Pro GSim_GRP_l1_process2a, fsearch_String, title=title, PSDeff=PSDeff, Per=Per, Cor = Cor, foldername=foldername
  ; --NOTE : DO NOT USE THIS UNLESS FOR A SPECIFIC CASE OF 
  ; This is modified from process2 just to see what happens with decimation 0/
  ;
  ...
  Openr, inunit, '/Users/sam/Dropbox/Cur_Work/auxpath/hdw_upper_limits.txt', /GET_LUN
  ...
  Openr, inunit, '/Users/sam/Dropbox/Cur_Work/auxpath/hdw_lower_limits.txt', /GET_LUN
