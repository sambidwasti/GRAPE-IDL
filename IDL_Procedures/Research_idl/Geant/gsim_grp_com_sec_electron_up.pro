Pro GSim_GRP_com_sec_electron_up, fsearch_String, title=title, bin=bin, Type=Type,foldername = foldername,N=N,Class=Class,Sep = Sep

  ; Secondary electron up
  ; This needs to read in the level 1 processed file. 
  ...
  ; Sambid Wasti : 08/15/2017
  ;     Adding the type flag. 
  ;Sambid Wasti : 10/03/2017
  ;   Adding few folders and other things for the automation.
...
;    help, pc_Hist
  ...
  if folderflag eq true then begin
   ...
   openw, lun1,foldername1+title1+'_'+Evt_Text+'_l1_SecUpElec_com.txt',/Get_Lun
