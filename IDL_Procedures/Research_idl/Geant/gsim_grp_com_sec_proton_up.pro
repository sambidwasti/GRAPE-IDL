Pro GSim_GRP_com_sec_proton_up, fsearch_String, title=title, bin=bin, Type=Type,foldername = foldername,N=N, Class = Class, Sep = Sep

  ; Normalizing and Combining the Sec Proton Up lvl1 output files.
  ; There are 7 of them. 
  ; Differentiated in Angle.
  ;
  ...
  mev_Const = 39.144+27.1539 ; This is for integrating through the energy ranges.
...
;  window,0
;  cgplot, xarray, Hist_tot, psym=10, /YLog, /Xlog , Xrange=[30,500], XStyle=1, YRange=[1E-7,2], YStyle=1, YMinor=10,$
;    xtitle= 'Energy(keV)', ytitle= 'Counts/s/keV', Title='PC All 1'
  ...
  openw, lun1,foldername1+title1+'_'+Evt_Text+'_l1_SecUpProt_com.txt',/Get_Lun
