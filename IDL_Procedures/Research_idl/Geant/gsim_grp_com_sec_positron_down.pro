Pro GSim_GRP_com_sec_positron_down, fsearch_String, title=title, bin=bin, type=type, foldername=foldername, N=N, Class = Class, Sep = Sep
...
;    print, p, ' ',infile
  ...
  openw, lun1,foldername1+title1+'_'+Evt_Text+'_l1_SecDownPosi_com.txt',/Get_Lun
