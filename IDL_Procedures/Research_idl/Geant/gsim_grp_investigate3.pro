Pro GSim_GRP_Investigate3, fsearch_String, title=title, nfiles= nfiles, PSDeff=PSDeff, Per=Per
  ;
  ...
  Crs_talk = 'Inv_Ct3_7a_'+strn(per)+'_'+ STRN(PSDEff)
  print, 'Crs_Talk % =', Per
  print, 'file=',Crs_talk
  ;
  ;=== PSD Efficiency ===
  ...
  for p =0, nfiles-1 Do Begin
    ...
    For i =0L, nevents-1 do Begin
      ...
      For k = 0,NoAnodes-1 Do Begin
        ...
        ;
        Temp_Arr = Grp_CT_Al_3(New_AnID[k],New_AnNrg[k],Per=Per)
